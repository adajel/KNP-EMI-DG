...
if __name__ == "__main__":
    ...
    # Membrane parameters
    g_syn_bar = 20   # synaptic conductivity (mS/cm**2)
    ...
    """ split domain into grid of size grid_size*grid_size*grid_size. Make
        checkerboard pattern and let 1/4 of each white square be an area for a synapse
    ____________
    |_  |_  |_  |
    |s|_|s|_|s|_|
    |_  |_  |_  |
    ...
    #print(synapse_grid)
    #x, y, z = 200e-7, 200e-7, 200e-7
    #x, y, z = 400e-7, 400e-7, 400e-7
    #print(eval(synapse_grid))

    #stimulus_locator = lambda x: eval(synapse_grid)
    #stimulus_locator = lambda x: (x[0] < 2500e-7) # cm
    ...
    #File("meshes/subdomains.pvd") << subdomains
    ...
    for facet in facets(mesh):
        ...
        # mark neuron facets
        elif (surfaces[facet] % 2) == 0 and surfaces[facet] != 0:
            surfaces[facet] = 1
        # mark glial facets
        elif (surfaces[facet] % 2) != 0 and surfaces[facet] != 0:
            surfaces[facet] = 2
    ...
    # write to file test
    File("meshes/surfaces.pvd") << surfaces
    File("meshes/subdomains.pvd") << subdomains
    ...
    # File for results
    fname = "results/data/EMIx-synapse/"
