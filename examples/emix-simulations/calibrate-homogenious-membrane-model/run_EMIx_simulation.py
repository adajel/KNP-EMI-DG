...
if __name__ == "__main__":
    ...
    # Set parameters
    solver_params = namedtuple('solver_params', ('direct_emi', 'direct_knp',
                               'rtol_emi', 'rtol_knp',
                               'atol_emi', 'atol_knp',
                               'threshold_emi', 'threshold_knp'
                               ))(direct_emi, direct_knp, \
    ...
    # Solve system
    S = SolverEMIx(params, ion_list)                # create solver
